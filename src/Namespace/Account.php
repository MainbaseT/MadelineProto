...
interface Account
{
     ...
     *
     * @param array{_: 'globalPrivacySettings', archive_and_mute_new_noncontact_peers?: bool, keep_archived_unmuted?: bool, keep_archived_folders?: bool, hide_read_marks?: bool, new_noncontact_peers_require_premium?: bool, display_gifts_button?: bool, noncontact_peers_paid_stars?: int, disallowed_gifts?: array{_: 'disallowedGiftsSettings', disallow_unlimited_stargifts?: bool, disallow_limited_stargifts?: bool, disallow_unique_stargifts?: bool, disallow_premium_gifts?: bool}} $settings Global privacy settings @see https://docs.madelineproto.xyz/API_docs/types/GlobalPrivacySettings.html
     * @param ?int $floodWaitLimit Can be used to specify a custom flood wait limit: if a FLOOD_WAIT_ rate limiting error is received with a waiting period bigger than this integer, an RPCErrorException will be thrown; otherwise, MadelineProto will simply wait for the specified amount of time. Defaults to the value specified in the settings: https://docs.madelineproto.xyz/PHP/danog/MadelineProto/Settings/RPC.html#setfloodtimeout-int-floodtimeout-self
     * @param ?string $queueId If specified, ensures strict server-side execution order of concurrent calls with the same queue ID.
     * @param ?\Amp\Cancellation $cancellation Cancellation
     * @param ?string $businessConnectionId Business connection ID, received through an updateBotBusinessConnect update.
     ...
     * @param array{_: 'businessBotRights', reply?: bool, read_messages?: bool, delete_sent_messages?: bool, delete_received_messages?: bool, edit_name?: bool, edit_bio?: bool, edit_profile_photo?: bool, edit_username?: bool, view_gifts?: bool, sell_gifts?: bool, change_gift_settings?: bool, transfer_and_upgrade_gifts?: bool, transfer_stars?: bool, manage_stories?: bool} $rights @see https://docs.madelineproto.xyz/API_docs/types/BusinessBotRights.html
     ...
     *
     * @param string $connection_id [Business connection ID »](https://core.telegram.org/api/business#connected-bots).
     * @param ?int $floodWaitLimit Can be used to specify a custom flood wait limit: if a FLOOD_WAIT_ rate limiting error is received with a waiting period bigger than this integer, an RPCErrorException will be thrown; otherwise, MadelineProto will simply wait for the specified amount of time. Defaults to the value specified in the settings: https://docs.madelineproto.xyz/PHP/danog/MadelineProto/Settings/RPC.html#setfloodtimeout-int-floodtimeout-self
     * @param ?string $queueId If specified, ensures strict server-side execution order of concurrent calls with the same queue ID.
     * @param ?\Amp\Cancellation $cancellation Cancellation
     * @return array @see https://docs.madelineproto.xyz/API_docs/types/Updates.html
     ...
     *
     *
     * @param array{_: 'profileTabPosts'}|array{_: 'profileTabGifts'}|array{_: 'profileTabMedia'}|array{_: 'profileTabFiles'}|array{_: 'profileTabMusic'}|array{_: 'profileTabVoice'}|array{_: 'profileTabLinks'}|array{_: 'profileTabGifs'} $tab @see https://docs.madelineproto.xyz/API_docs/types/ProfileTab.html
     * @param ?int $floodWaitLimit Can be used to specify a custom flood wait limit: if a FLOOD_WAIT_ rate limiting error is received with a waiting period bigger than this integer, an RPCErrorException will be thrown; otherwise, MadelineProto will simply wait for the specified amount of time. Defaults to the value specified in the settings: https://docs.madelineproto.xyz/PHP/danog/MadelineProto/Settings/RPC.html#setfloodtimeout-int-floodtimeout-self
     * @param ?string $queueId If specified, ensures strict server-side execution order of concurrent calls with the same queue ID.
     * @param ?\Amp\Cancellation $cancellation Cancellation
     */
     ...
     * @param array $after_id @see https://docs.madelineproto.xyz/API_docs/types/InputDocument.html
     * @param ?int $floodWaitLimit Can be used to specify a custom flood wait limit: if a FLOOD_WAIT_ rate limiting error is received with a waiting period bigger than this integer, an RPCErrorException will be thrown; otherwise, MadelineProto will simply wait for the specified amount of time. Defaults to the value specified in the settings: https://docs.madelineproto.xyz/PHP/danog/MadelineProto/Settings/RPC.html#setfloodtimeout-int-floodtimeout-self
     * @param ?string $queueId If specified, ensures strict server-side execution order of concurrent calls with the same queue ID.
     * @param ?\Amp\Cancellation $cancellation Cancellation
     */
